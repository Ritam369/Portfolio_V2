// ProjectCard — displays a single featured project.
...
export default function ProjectCard({ title, description, techStack = [], liveUrl, repoUrl }) {
  return (
    <article className="border border-border-subtle rounded-md p-5 bg-bg-surface hover:border-[#3a3a3a] transition-colors duration-150">
